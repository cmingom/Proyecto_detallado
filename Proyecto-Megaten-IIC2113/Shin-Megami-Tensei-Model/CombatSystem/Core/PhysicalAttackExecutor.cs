...
{
    public class PhysicalAttackExecutor : IActionExecutor
    {
        private readonly DamageCalculator damageCalculator;
        private readonly IBattleView battleView;

        public PhysicalAttackExecutor(DamageCalculator damageCalculator, IBattleView battleView)
        {
        ...
        {
            var attackContext = new AttackContext(actingUnit, battleState, AttackType.Physical);
        ...
        {
            return damageCalculator.CalculatePhysicalDamage(attackContext.Attacker.Str);
        }
        ...
        {
            battleView.ShowAttackResult(attackContext.Attacker, target, damage, false);
        }
    }
}
